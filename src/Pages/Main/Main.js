...
export default function Main() {
  ...
  const [unsortedNums, setUnsortedNums] = useState([]);
    ...
    <ThemeProvider theme={theme}>
      <StyledMain>
        ...
        <StyledSection>
          ...
          />
          <AscendingField nums={unsortedNums} />
...
const StyledMain = styled.main`
  ...
  @media screen and ${({ theme }) => theme.device.tablet} {
    padding: 0 ${({ theme }) => theme.layout.md_margin}
      ${({ theme }) => theme.layout.md_margin};
  }

  @media screen and ${({ theme }) => theme.device.mobile} {
    padding: 0 ${({ theme }) => theme.layout.sm_margin}
      ${({ theme }) => theme.layout.sm_margin};
  }
`;
...
const StyledSection = styled.section`
  ...
  @media screen and ${({ theme }) => theme.device.tablet} {
    min-height: calc(100vh - (60px + ${({ theme }) => theme.layout.md_margin}));
  }

  @media screen and ${({ theme }) => theme.device.mobile} {
    min-height: calc(100vh - (60px + ${({ theme }) => theme.layout.sm_margin}));
  }
`;
